 ...
 * 
 * import kr.co.soccer.exception.BizDuplicateKeyException; import
 * kr.co.soccer.exception.BizNotEffectedException; import
 * kr.co.soccer.exception.BizNotFoundException;
 * 
 ...
 * MemberVO vo = memberDao.getMember(memId); if (vo == null) { throw new
 * BizNotFoundException("[" + memId + "] 조회 실패"); } return vo; }
 * 
 * public List<MemberVO> getMemberList(MemberSearchVO searchVO) { // 건수를 구해서
 * searchVO 설정 -> searchVO.pageSetting() ->list 호 int cnt =
 * memberDao.getMemberCount(searchVO); searchVO.setTotalRowCount(cnt);
 * searchVO.pageSetting();
 * 
 * List<MemberVO> list = memberDao.getMemberList(searchVO); return list; }
 * 
