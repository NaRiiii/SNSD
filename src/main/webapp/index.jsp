...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/iconfont.css">
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
                        ...
                        <div class="main_service">
                            ...
                            <div class="col-md-6 col-sm-12 no-padding">
                                <figure class="single_service single_service_img">
                                    ...
                                    <img src="${pageContext.request.contextPath}/resources/images/servicerightimg.jpg" alt="" />
                                </figure><!-- End of figure -->
                            </div><!-- End of col-sm-6 -->
                        ...
                        <div class="main_portfolio">
                            ...
                            <div id="portfoliowork"> 
                                <div class="single_portfolio tile scale-anm web grid-item-width2 video" >
                                    <img src="${pageContext.request.contextPath}/resources/images/pf1.jpg" alt="" />
                                    <a href="${pageContext.request.contextPath}/resources/images/pf1.jpg" class="portfolio-img">
                                ...
                                <div class="single_portfolio tile scale-anm bcards photo" >
                                    <img src="${pageContext.request.contextPath}/resources/images/pf2.jpg" alt="" />
                                    <a href="${pageContext.request.contextPath}/resources/images/pf2.jpg" class="portfolio-img">
                                        <div class="grid_item_overlay">
                                            <div class="separator4"></div>
                                            <h3>T-SHIRT DESIGN</h3>
                                            <p>art / t-shirt</p>
                                ...
                                <div class="single_portfolio tile scale-anm web video">
                                    <img src="${pageContext.request.contextPath}/resources/images/pf3.jpg" alt="" />
                                    <a href="${pageContext.request.contextPath}/resources/images/pf3.jpg" class="portfolio-img">
                                        <div class="grid_item_overlay">
                                            <div class="separator4"></div>
                                            <h3>T-SHIRT DESIGN</h3>
                                            <p>art / t-shirt</p>
                                ...
                                <div class="single_portfolio tile scale-anm web photo" >
                                    <img src="${pageContext.request.contextPath}/resources/images/pf4.jpg" alt="" />
                                    <a href="${pageContext.request.contextPath}/resources/images/pf4.jpg" class="portfolio-img">
                                        <div class="grid_item_overlay">
                                            <div class="separator4"></div>
                                            <h3>T-SHIRT DESIGN</h3>
                                            <p>art / t-shirt</p>
                                ...
                                <div class="single_portfolio tile scale-anm bcards design" >
                                    <img src="${pageContext.request.contextPath}/resources/images/pf5.jpg" alt="" />  
                                    <a href="${pageContext.request.contextPath}/resources/images/pf5.jpg" class="portfolio-img">
                                        <div class="grid_item_overlay">
                                            <div class="separator4"></div>
                                            <h3>T-SHIRT DESIGN</h3>
                                            <p>art / t-shirt</p>
                                ...
                                <div class="single_portfolio tile scale-anm flyers video design">
                                    <img src="${pageContext.request.contextPath}/resources/images/pf6.jpg" alt="" />
                                    <a href="${pageContext.request.contextPath}/resources/images/pf6.jpg" class="portfolio-img">
                                        <div class="grid_item_overlay">
                                            <div class="separator4"></div>
                                            <h3>T-SHIRT DESIGN</h3>
                                            <p>art / t-shirt</p>
                                ...
                                <div class="single_portfolio tile scale-anm photo flyers">
                                    <img src="${pageContext.request.contextPath}/resources/images/pf7.jpg" alt="" />
                                    <a href="${pageContext.request.contextPath}/resources/images/pf7.jpg" class="portfolio-img">
                                        <div class="grid_item_overlay">
                                            <div class="separator4"></div>
                                            <h3>T-SHIRT DESIGN</h3>
                                            <p>art / t-shirt</p>
                                ...
                                <div class="single_portfolio tile scale-anm bcards video" >
                                    <img src="${pageContext.request.contextPath}/resources/images/pf8.jpg" alt="" />
                                    <a href="${pageContext.request.contextPath}/resources/images/pf8.jpg" class="portfolio-img">
                                        <div class="grid_item_overlay">
                                            <div class="separator4"></div>
                                            <h3>T-SHIRT DESIGN</h3>
                                            <p>art / t-shirt</p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="single_team_img">
                                                <img src="${pageContext.request.contextPath}/resources/images/team1.jpg" alt="" />
                                            </div>
                                        ...
                                        <li>
                                            <div class="single_team_img">
                                                <img src="${pageContext.request.contextPath}/resources/images/team2.jpg" alt="" />
                                            </div>
                                            <div class="single_team_text">
                                                <h4>Kazi Erfan</h4>
                                                <p>Engineering</p>
                                        ...
                                        <li>
                                            <div class="single_team_img">
                                                <img src="${pageContext.request.contextPath}/resources/images/team3.jpg" alt="" />
                                            </div>
                                            <div class="single_team_text">
                                                <h4>Jeng Koli</h4>
                                                <p>Designer</p>
                                        ...
                                        <li>
                                            <div class="single_team_img">
                                                <img src="${pageContext.request.contextPath}/resources/images/team4.jpg" alt="" />
                                            </div>
                                            <div class="single_team_text">
                                                <h4>Pet Romak</h4>
                                                <p>Marketing</p>
                                        ...
                                        <li>
                                            <div class="single_team_img">
                                                <img src="${pageContext.request.contextPath}/resources/images/test2.jpg" alt="" />
                                            </div>
                                            <div class="single_team_text">
                                                <h4>Chet Pok</h4>
                                                <p>Web Developer</p>
                    ...
                    <div class="row">
                        <div class="main_clogo sections text-center">
                            ...
                            <div class="col-sm-3 col-xs-6"> 
                                <a href=""><img src="${pageContext.request.contextPath}/resources/images/clogo1.png" alt="" /></a>
                            </div>
                            <div class="col-sm-3 col-xs-6"> 
                                <a href=""><img src="${pageContext.request.contextPath}/resources/images/clogo2.png" alt="" /></a>
                            </div>
                            <div class="col-sm-3 col-xs-6"> 
                                <a href=""><img src="${pageContext.request.contextPath}/resources/images/clogo3.png" alt="" /></a>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <a href=""><img src="${pageContext.request.contextPath}/resources/images/clogo4.png" alt="" /></a>
                            </div>
                            <div class="col-sm-3 col-xs-6"> 
                                <a href=""><img src="${pageContext.request.contextPath}/resources/images/clogo5.png" alt="" /></a>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <a href=""><img src="${pageContext.request.contextPath}/resources/images/clogo6.png" alt="" /></a>
                            </div>
                            <div class="col-sm-3 col-xs-6"> 
                                <a href=""><img src="${pageContext.request.contextPath}/resources/images/clogo9.png" alt="" /></a>
                            </div>
                            <div class="col-sm-3 col-xs-6">
                                <a href=""><img src="${pageContext.request.contextPath}/resources/images/clogo8.png" alt="" /></a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 no-padding">
                                                <div class="single_blog_img">
                                                    <img src="${pageContext.request.contextPath}/resources/images/blog1.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6 no-padding">
                                ...
                                <div class="col-sm-6">
                                    <div class="single_blog_area textwhite">
                                        <div class="row">
                                            <div class="col-sm-6 no-padding">
                                                <div class="single_blog_img">
                                                    <img src="${pageContext.request.contextPath}/resources/images/blog2.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6 no-padding">
                                                <div class="single_blog_text s_b_left">
                                    ...
                                    <div class="single_blog_area textwhite">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-sm-push-6 no-padding">
                                                <div class="single_blog_img">
                                                    <img src="${pageContext.request.contextPath}/resources/images/blog3.jpg" alt="" />
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="single_blog_area textwhite">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-push-6 no-padding">
                                                <div class="single_blog_img">
                                                    <img src="${pageContext.request.contextPath}/resources/images/blog4.jpg" alt="" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-sm-pull-6 no-padding">
                                                <div class="single_blog_text s_b_right">
        ...
        <!--slick slide js -->
        <script src="<c:url value='/resources/css/slick/slick.js' />"></script>
        <script src="<c:url value='/resources/css/slick/slick.min.js' />"></script>
